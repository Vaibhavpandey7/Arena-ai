 ...
 */
export function calculateTokensPerSec(latencyMs, completionTokens) {
    if (!latencyMs || latencyMs <= 0 || !completionTokens || completionTokens <= 0)
        return 0;
 ...
 */
export function evaluateGoldAlignment(modelAnswer, goldResponse, evidence) {
